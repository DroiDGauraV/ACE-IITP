...
public class OngoingEventsRecyclerViewAdapter extends RecyclerView.Adapter<OngoingEventsRecyclerViewAdapter.DataViewHolder>
    ...
    public OngoingEventsRecyclerViewAdapter(EventClick recyclerViewClick) {
    ...
    class DataViewHolder extends RecyclerView.ViewHolder {
        ...
        public DataViewHolder(View view) {
            ...
            view.setOnClickListener(v -> recyclerViewClick.activeClick(getAdapterPosition()));
        }
    }
}
