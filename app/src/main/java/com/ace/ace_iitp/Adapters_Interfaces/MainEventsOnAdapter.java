...
public class MainEventsOnAdapter extends RecyclerView.Adapter<MainEventsOnAdapter.NewViewHolder>{

    private List<EventsDataItems> slideItems;
    private EventClick recyclerViewClick;

    public MainEventsOnAdapter(EventClick recyclerViewClick) {
    ...
    public NewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MainEventsOnAdapter.NewViewHolder(LayoutInflater.from(parent.getContext())
    ...
    class NewViewHolder extends RecyclerView.ViewHolder {
        ...
        public NewViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(v->recyclerViewClick.nonactiveClick(getAdapterPosition()));
        }
